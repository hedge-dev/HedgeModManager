...
public partial class SettingsMain : SettingsBase
{
    public static readonly StyledProperty<UIGame?> GameProperty =
        AvaloniaProperty.Register<SettingsMain, UIGame?>(nameof(Game));

    public static readonly StyledProperty<ModProfile?> ProfileProperty =
        AvaloniaProperty.Register<SettingsMain, ModProfile?>(nameof(Profile));
    ...
    public SettingsMainViewModel ViewModel { get; set; } = new();
    ...
    private void OnThemeSelectionChanged(object? sender, SelectionChangedEventArgs e)
    {
        if (DataContext is MainWindowViewModel mainViewModel &&
            ...
            comboBox.SelectedItem is SettingsMainViewModel.Theme theme)
        {
    ...
    private void OnSettingsIntegrations(object? sender, RoutedEventArgs e)
    {
        Settings?.SwitchPanel(new SettingsIntegrations());
    }
